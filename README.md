...
║     ╚═════╝ ╚═════╝  ╚═════╝ ╚═╝  ╚═══╝╚═╝   ╚═╝   ╚═╝  ╚═══╝  ╚══════╝   ║
╠══════════════════════════════════════════════════════════════╣
║   🧠 Meso-Cosmos Agent · BDI + ReAct · Hub-and-Spoke Graph  ║
║   ⚡ Cognitive Reconstruction · Signified over Signifier     ║
╚══════════════════════════════════════════════════════════════╝
```
...
- [🧠 Intelligent Optimization Layers](#-intelligent-optimization-layers)
- [🔺 Triangle Core + Derived Role: V/V1 (Validation)](#-triangle-core--derived-role-vv1-validation)
- [📊 Self-Assessment](#-self-assessment)
- [📋 Version History](#-version-history)
- [🔗 Linked Projects](#-linked-projects)
- [🧠 v5.2: Meso-Cosmos Agent](#-v52-meso-cosmos-agent-中宇宙式协调)
- [🧠 v5.1: Hub-and-Spoke Search Protocol](#-v51-hub-and-spoke-search-protocol)
- [🔺 Triangle Core + Derived Architecture (Cross-Project)](#-triangle-core--derived-architecture-cross-project)
- [🔧 Engineering Language Commitment](#-engineering-language-commitment)
- [🧠 Core Innovation](#-core-innovation)
- [🏆 Why This Is the Most Advanced Species Search Engine](#-why-this-is-the-most-advanced-species-search-engine)
- [🆕 v5.4.0 New Features](#-v540-new-features)
- [🚀 Quick Start](#-quick-start)
- [📁 Project Structure](#-project-structure)
- [🔬 How It Works](#-how-it-works)
- [📡 Search Engines (built-in)](#-search-engines-built-in)
...
## 🔺 Triangle Core + Derived Role: **V/V1 (Validation)**
...
## 🧠 v5.2: Meso-Cosmos Agent (中宇宙式协调)

> **Macro(BDI) → Meso(Coordination) → Micro(Execution)** — automatically bridges the gap between macro intent and micro tool invocation.

### What's New

<details open><summary><b>📋 Meso-Cosmos Features</b></summary>
...
| **Chinese Academic Search** | Specialized search for 8 Chinese journals | `skills/chinese-academic-search.md` |
...
## 🔺 Triangle Core + Derived Architecture (Cross-Project)

> Triangle Core (sealed 3): `S/V0` (fish) → `V/V1` (cognitive) → `Coord` (eon-core). Derived (open N): `P₁` (porpoise), `P₂` (coilia), `P₃` (culter), `C` (arbiter).
...
<details open><summary><b>📊 Comparison: Traditional vs Cognitive Search</b></summary>
...
<details open><summary><b>📊 Comparison: AI vs Cognitive Search</b></summary>
...
→ 🟢 ≥80 高可信度  🟡 60-79 中  🟠 40-59 低  🔴 <40 不可用
```
...
<details open><summary><b>📋 v5.4.0 Feature List</b></summary>
...
| ⚖ Agent Judge | ✅ | LLM-based 4-dimension evaluation |
...
<details open><summary><b>📂 File Tree</b></summary>
...
`cognitive-search` `species-search` `bdi-agent` `react-loop` `hub-and-spoke` `knowledge-graph` `meso-cosmos` `authority-scoring` `thompson-sampling` `pid-limiter` `llm` `reasonix` `mcp` `ocr-variants` `chinese-academic`

<br>

<sub>🔍 Part of the **SanShengWanWu** ecosystem · V/V1 Validation · Coordinated by [eon-core](https://github.com/fangtaocai041/eon-core)</sub>
